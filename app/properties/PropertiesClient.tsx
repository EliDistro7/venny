...
export default function PropertiesClient() {
  ...
  const filtered = useMemo(() => {
    return properties.filter((p) => {
      ...
      return cityMatch && categoryMatch && dealMatch && priceMatch;
    });
  }, [city, category, deal, maxPrice]);
      ...
      <div style={{ backgroundColor: "#1C1C1E" }} className="pt-32 pb-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="mt-3 font-body" style={{ color: "rgba(248, 245, 240, 0.6)" }}>
            {filtered.length} properties available across Tanzania
          </p>
        </div>
      </div>
            ...
            >
              ...
              <div className="mb-6">
                ...
                <select
                  ...
                  style={{ backgroundColor: "#F8F5F0", color: "#1C1C1E", border: "1px solid rgba(242,201,76,0.3)" }}
                >
                  {cities.map((c) => (
          ...
          <div className="md:col-span-3">
            {filtered.length === 0 ? (
              ...
              >
                ...
                <p className="font-bold text-lg mb-2" style={{ color: "#1C1C1E", fontFamily: "Georgia, serif" }}>
